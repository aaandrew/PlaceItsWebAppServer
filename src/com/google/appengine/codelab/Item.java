...
public class Item {
   ...
   * @return
   */
  public static Entity createOrUpdateItem(String productName, String itemName,String Long, String Lat, String Iscategory, String Categoryhead) {
	  ...
	  item.setProperty("long", Long);
	  item.setProperty("lat", Lat);
	  item.setProperty("iscategory", Iscategory);
	  item.setProperty("categoryhead", Categoryhead);
	  } 
	  else{ 
		  item.setProperty("name", itemName); 
		  item.setProperty("product", productName); 
