...
public class ItemServlet extends BaseServlet {
  ...
  protected void doPut(HttpServletRequest req, HttpServletResponse resp)
    ...
    String isCategory = req.getParameter("iscategory");
    String categoryhead = req.getParameter("categoryhead");
    Item.createOrUpdateItem(productName, itemName, longi, Lat, isCategory, categoryhead);
  }
